      ...
      <section className="py-16 bg-[#faf9f7] dark:bg-[#0f0f0e]">
        <div className="max-w-3xl mx-auto px-6 lg:px-12">
          ...
          <article className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-medium tracking-wider text-[#1a1a1a] dark:text-[#e8e6e3] mb-6">
              策展理念
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-[#f5f3ef] dark:bg-[#171614] p-6 rounded-sm">
                <h3 className="text-lg font-medium text-[#1a1a1a] dark:text-[#e8e6e3] mb-2">建窑茶盏</h3>
                <p className="text-sm text-[#666] dark:text-[#9a9894] leading-relaxed">
                  宋代点茶文化的代表，黑釉上的「兔毫」「油滴」「曜变」纹理各具神韵，为日本茶道所推崇的「天目」之源。
                </p>
              </div>
              <div className="bg-[#f5f3ef] dark:bg-[#171614] p-6 rounded-sm">
                <h3 className="text-lg font-medium text-[#1a1a1a] dark:text-[#e8e6e3] mb-2">龙泉青瓷</h3>
                <p className="text-sm text-[#666] dark:text-[#9a9894] leading-relaxed">
                  南宋龙泉窑以「梅子青」「粉青」等釉色闻名天下，如玉般温润的质感体现了宋人含蓄内敛的审美理想。
                </p>
              </div>
              <div className="bg-[#f5f3ef] dark:bg-[#171614] p-6 rounded-sm">
                <h3 className="text-lg font-medium text-[#1a1a1a] dark:text-[#e8e6e3] mb-2">宜兴紫砂</h3>
                <p className="text-sm text-[#666] dark:text-[#9a9894] leading-relaxed">
                  「世间茶具之首」，紫砂壶透气性佳，能养茶香，自明代起成为文人雅玩，至今仍是茶人挚爱。
                </p>
              </div>
              <div className="bg-[#f5f3ef] dark:bg-[#171614] p-6 rounded-sm">
                <h3 className="text-lg font-medium text-[#1a1a1a] dark:text-[#e8e6e3] mb-2">官窑瓷器</h3>
                <p className="text-sm text-[#666] dark:text-[#9a9894] leading-relaxed">
            ...
            <ul className="text-[#3d3d3d] dark:text-[#c5c3bf] space-y-2 mb-6">
            ...
            <div className="bg-[#1a1a1a] dark:bg-[#252320] text-[#faf9f7] p-8 rounded-sm mt-12">
              <p className="text-center text-lg tracking-wide">
                「一器一茶，皆有其道」
              </p>
              <p className="text-center text-sm text-[#999] dark:text-[#6e6c68] mt-2 font-serif-en">
